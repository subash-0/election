          ...
          <Card className="border-none shadow-xl shadow-slate-200/50 overflow-hidden bg-white">
            ...
            <CardContent className="p-0">
              <div className="divide-y divide-slate-100">
                ...
                <CompareRow icon={<MapPin className="w-4 h-4" />} label="निर्वाचन क्षेत्र" left={`${A.DistrictName} - ${A.ConstName}`} right={`${B.DistrictName} - ${B.ConstName}`} />
      ...
      <CardContent className="p-8">
        <div className="flex flex-col items-center text-center space-y-4">
          <div className="w-20 h-20 rounded-full bg-slate-100 flex items-center justify-center mb-2 border-4 border-white shadow-md">
            <span className="text-xs font-bold text-slate-400 uppercase mb-3">चिन्ह</span>
